...
# written in section 8.5 (after FINAL_PROMPT is known) and checked below.
SENTINEL="${CLAUDE_PROJECT_DIR:-.}/.better-prompt-sentinel"
...
#
# Flow:
#   first run  → hash of ENHANCED_PROMPT written to $SENTINEL  (section 8.5)
...
# ═════════════════════════════════════════════════════════════════════════════
# 8.5 Write content-hash sentinel
